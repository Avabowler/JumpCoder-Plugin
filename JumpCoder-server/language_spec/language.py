...
class LanguageSpec:
    ...
    def of(language_name: str) -> "LanguageSpec":
        from language_spec.python import PythonSpec
        from language_spec.java import JavaSpec
        from language_spec.cpp import CppSpec
        from language_spec.js import JavaScriptSpec
        from language_spec.cs import CSharpScriptSpec
