...
接下来运行JumpCoder_Backend_Server。注意这里的地址是你在Step 1中部署进行生成或者填充的大模型的地址。JumpCoder_Backend_Server默认运行在127.0.0.1:5000端口，你可以自己调整端口。
...
你可以在插件中修改成自己配置JumpCoder_Backend_Server的地址以便使用JumpCoder。
