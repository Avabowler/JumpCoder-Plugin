...
import { processSelectedSnippet } from './snippetProcessor';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    const processSnippetCommand = vscode.commands.registerTextEditorCommand('extension.processSnippet', processSelectedSnippet);
...
async function performSearch(panel: vscode.WebviewPanel, params: SearchParams): Promise<void> {
    try {
